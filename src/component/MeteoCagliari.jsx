...
const URL =
  "https://api.openweathermap.org/data/2.5/weather?q=cagliari&appid=d04847d0ccf1f732058eb7980085731e";

class MeteoCagliari extends Component {
  state = {
    previsioni: {},
  };
