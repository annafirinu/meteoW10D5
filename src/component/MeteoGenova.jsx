...
const URL =
  "https://api.openweathermap.org/data/2.5/weather?q=genova&appid=d04847d0ccf1f732058eb7980085731e";

class MeteoGenova extends Component {
  state = {
    previsioni: {},
  };
